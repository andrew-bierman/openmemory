...
profile and workspace settings, invite and remove a team member, create and
disable a dashboard-managed MCP OAuth client, revoke a seeded OAuth/MCP
connection, and delete the test account through the Admin danger zone.
